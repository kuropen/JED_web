...
type JED_Area = {
  ...
  readonly name: Scalars['String'];
  readonly longName: Scalars['String'];
  readonly officialWeb: Scalars['String'];
  readonly csvFile: Scalars['String'];
  readonly csvFiveMinPos: Scalars['Int'];
  readonly csvHourlyPos: Scalars['Int'];
  readonly hasWindData: Maybe<Scalars['Boolean']>;
  readonly peak: Maybe<ReadonlyArray<Maybe<JED_PeakElectricity>>>;
  readonly hourly: Maybe<ReadonlyArray<Maybe<JED_HourlyDemand>>>;
};
...
type JED_PeakElectricity = {
  readonly id: Scalars['Int'];
  readonly createdAt: Scalars['JED_Date'];
  readonly updatedAt: Scalars['JED_Date'];
  readonly areaId: Scalars['Int'];
  readonly date: Scalars['JED_Date'];
  readonly expectedHour: Scalars['String'];
  readonly type: JED_PeakType;
  readonly percentage: Scalars['Int'];
  readonly reservePct: Maybe<Scalars['Int']>;
  readonly isTomorrow: Maybe<Scalars['Boolean']>;
  readonly amount: Scalars['Int'];
  readonly supply: Scalars['Int'];
};

type JED_PeakElectricityInput = {
  readonly areaId: Scalars['Int'];
...
type JED_HourlyDemand = {
  ...
  readonly supply: Scalars['Int'];
  readonly percentage: Scalars['Int'];
  readonly absTime: Maybe<Scalars['JED_Date']>;
};

type JED_HourlyDemandInput = {
  readonly areaId: Scalars['Int'];
  readonly date: Scalars['String'];
  readonly hour: Scalars['Int'];
  readonly amount: Scalars['Int'];
...
type JED_FiveMinDemand = {
  ...
  readonly amount: Scalars['Int'];
  readonly solar: Maybe<Scalars['Int']>;
  readonly wind: Maybe<Scalars['Int']>;
  readonly absTime: Maybe<Scalars['JED_Date']>;
};

type JED_FiveMinDemandInput = {
  readonly areaId: Scalars['Int'];
  readonly date: Scalars['String'];
  readonly time: Scalars['String'];
  readonly amount: Scalars['Int'];
...
type JED = {
  ...
  readonly allArea: ReadonlyArray<JED_Area>;
  readonly areaByCode: Maybe<JED_Area>;
  readonly peakElectricity: Maybe<ReadonlyArray<Maybe<JED_PeakElectricity>>>;
  readonly hourlyDemand: Maybe<ReadonlyArray<Maybe<JED_HourlyDemand>>>;
  readonly fiveMinDemand: Maybe<ReadonlyArray<Maybe<JED_FiveMinDemand>>>;
};


type JED_areaByCodeArgs = {
  code: Scalars['String'];
};
...
type JED_hourlyDemandArgs = {
  areaCode: Maybe<Scalars['String']>;
  limit: Maybe<Scalars['Int']>;
};


type JED_fiveMinDemandArgs = {
  areaCode: Maybe<Scalars['String']>;
  limit: Maybe<Scalars['Int']>;
};
...
type LayoutMetaQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title'>> }> };
